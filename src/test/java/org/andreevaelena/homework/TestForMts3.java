...
public class TestForMts3 {
    ...
    public void testPaymentFormButtonFunctionality() {
        ...
        WebElement submitButton = wait2.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@class='colored disabled ng-star-inserted']")));

        String submitButtonText = submitButton.getText().replaceAll("\\s+", " ");
        Assertions.assertTrue(submitButtonText.contains("Оплатить 5.00 BYN"));
    }
}
